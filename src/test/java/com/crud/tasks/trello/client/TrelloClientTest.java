...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("ewalorek");
    }
    ...
    public void shouldCreateCard() throws URISyntaxException {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test task", "Test description", "top",
                "test_id"
        );
...
//        //Given
//        URI uri = new URI
//        when(restTemplate.postForObject(uri, null, TrelloListDto))
//        //When
//
//        //Then
//
